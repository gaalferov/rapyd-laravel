...
if (version_compare(app()->version(), '5.2')>0)
{
    Route::group(['middleware' => 'web'], function () {
        Route::get('rapyd-ajax/{hash}', array('as' => 'rapyd.remote', 'uses' => '\Iginikolaev\Rapyd\Controllers\AjaxController@getRemote'));
        //Route::controller('rapyd-demo', '\Iginikolaev\Rapyd\Demo\DemoController');
